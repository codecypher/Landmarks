/*
  Create a new custom view cfor the mountain shape that is stamped
  in a rotated pattern in the badge design.
 
  Abstract: A view that display a symbol in a badge.
*/
